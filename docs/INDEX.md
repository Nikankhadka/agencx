...
| **4. Ship** (Week 4) | Customer + platform surfaces, dashboards, Terraform/AWS + Vercel deploy, Tenant 2 generalization proof, artifacts | `INDEX.md` + `phases/phase-4-ship.md` + per-ticket sections of both design docs | `[x]`* (*8/9 done; T-036 deploy + demo video pending, both founder-blocked. See `PROGRESS.md`.) |
| **5. Agentic conversation** (post-ship) | Tool-driven onboarding copilot + conversational customer chat; retire the hardcoded state machine | `INDEX.md` + `phases/phase-5-agentic-conversation.md` + per-ticket sections of `design/database.md` | `[~]` |
...
docs/
  ...
  phases/
    ...
    phase-5-agentic-conversation.md  <- tickets T-041..T-044
