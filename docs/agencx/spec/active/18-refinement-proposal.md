...
**Status:** Active - todo.
**Phase 1 area:** Refinement proposal.

This proposal (RF-1 through RF-17) is distinct from the M-7 storefront
redesign (`active/17-storefront-redesign.md`, lands with
`feat/m7-storefront-redesign`) and from [frontend-refinement.md](../../design/frontend-refinement.md)
(the UI companion this proposal's RF tickets map to).
