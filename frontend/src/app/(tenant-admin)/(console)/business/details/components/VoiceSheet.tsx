      ...
      {preset === CUSTOM ? (
        <label className="block">
          ...
          <textarea
            ...
            className="w-full resize-none rounded-field border-chip border-border bg-surface px-4 py-4 text-field text-text outline-none transition-colors duration-(--duration-fast) placeholder:text-ink-a40 focus:border-text"
          />
