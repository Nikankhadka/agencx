      ...
      <body className="min-h-full flex flex-col">
        ...
        >
          ...
          <button
            ...
            className="mt-2 inline-flex items-center justify-center rounded-md border border-border bg-surface px-4 py-2 text-body font-medium text-text transition-colors duration-fast hover:bg-surface-sunken"
          >
            Try again
          </button>
        </main>
